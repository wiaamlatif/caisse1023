...
<?php 
    ...
    $classAlert="alert alert-info py-2 mx-2 w-60";
    ...
    if(isset($_SESSION['user']['xz'])){
      ...
      $message=$xz." / Liste des articles vendus depuis la derniere MAZ du manager";
              ...
              <tr>
                  ...
                  <td>
                    <div class="d-flex py-2">
                      <form action="articlesXDetail.php" method="post">             
